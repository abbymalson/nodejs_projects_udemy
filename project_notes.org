...
**** Cassandra Install & Setup
     ...
     INSERT INTO doctors(doc_id, full_name, category, practice_name, street_adress, city, state, new_patients, graduation_year) VALUES(now(), 'william k samson md', 'neurologist, 'family medical', '30 congress st', 'boston', 'ma', true, 1997);
     SELECT * FROM doctors;
     INSERT INTO doctors(doc_id, full_name, category, practice_name, street_adress, city, state, new_patients, graduation_year) VALUES(now(), 'tom k sammy md', 'gastro intestinal', 'private practice', '30 congress st', 'boston', 'ma', true, 1997);
